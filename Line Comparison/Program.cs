...
namespace Line_Comparison
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter the x1 co-ordibate");
            float x2 = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Enter the y1 co-ordibate");
            float y2 = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Enter the x2 co-ordibate");
            float x3 = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Enter the y2 co-ordibate");
